...
setup(
    ...
    install_requires=['androguard>=3.4.0a1', 'networkx', 'Pillow', 'requests', 'pyvis', 'treelib', 'pyyaml', 'torch', 'InstructorEmbedding', 'sentence_transformers', 'pytesseract'],
)
